...
export default function Hero() {
    return (
        ...
        >
            ...
            <div className="relative mx-auto grid min-h-[720px] max-w-[1440px] grid-cols-1 lg:min-h-[900px] lg:grid-cols-[1fr_700px]">
                <div className="relative min-h-[420px] lg:min-h-[900px]">
                    <div className="absolute left-4 right-4 top-8 sm:left-6 sm:right-6 lg:left-[72px] lg:right-auto lg:top-auto lg:bottom-[120px] flex max-w-[620px] flex-col gap-8">
