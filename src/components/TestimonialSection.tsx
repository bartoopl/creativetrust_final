        ...
        <section style={{ borderTop: '1px solid var(--line)', borderBottom: '1px solid var(--line)', background: 'var(--panel2)' }}>
            <div style={{ maxWidth: 1000, margin: '0 auto', padding: '80px 32px', textAlign: 'center' }}>
                ...
                <div style={{ marginTop: 28, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12 }}>
                    <span style={{ width: 40, height: 40, borderRadius: '50%', background: 'repeating-linear-gradient(135deg, var(--panel) 0 6px, color-mix(in srgb, var(--accent) 14%, var(--panel)) 6px 12px)', border: '1px solid var(--line)', display: 'inline-block' }} />
                    <div style={{ textAlign: 'left' }}>
                        <div style={{ fontWeight: 600, fontSize: 15, fontFamily: 'var(--font-space), sans-serif' }}>Klient CreativeTrust</div>
                        <div style={{ color: 'var(--muted)', fontSize: 13 }}>Head of Growth</div>
                    </div>
                </div>
            </div>
        </section>
