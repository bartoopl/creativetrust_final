        ...
        <section style={{ background: '#fff', padding: '120px 72px' }}>
            <div style={{ maxWidth: 1440, margin: '0 auto' }}>
                <div style={{ textAlign: 'center', marginBottom: 64 }}>
                    <h2 style={{ fontFamily: 'var(--font-space), sans-serif', fontWeight: 500, fontSize: 'clamp(34px, 4vw, 43.1px)', lineHeight: '48.4px', letterSpacing: '-1.76px', color: '#000', margin: 0 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 32, padding: '0 80px' }}>
                    <div style={{ display: 'flex', gap: 32, height: 360 }}>
                        <div style={{ flex: 662, borderRadius: 4, background: '#000', overflow: 'hidden', position: 'relative', padding: 32 }}>
                            ...
                            <p style={{ position: 'absolute', bottom: 32, left: 32, fontSize: 15.4, fontWeight: 500, lineHeight: '24px', letterSpacing: '-0.32px', color: '#fff', margin: 0 }}>
                                Klienci z Polski i z zagranicy · Projekty z mierzalnymi wynikami
                            </p>
                        </div>
                        <div style={{ flex: 441, borderRadius: 4, background: '#fff', boxShadow: 'inset 0 0 0 1px rgba(0,0,0,0.08)', overflow: 'hidden', padding: 33 }}>
                    ...
                    <div style={{ display: 'flex', gap: 32 }}>
                        ...
                        <div style={{ flex: 662, borderRadius: 4, background: 'rgba(0,0,0,0.04)', overflow: 'hidden', padding: 32, display: 'flex', flexDirection: 'column', gap: 36 }}>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                                <p style={{ fontSize: 17, fontWeight: 500, lineHeight: '27px', letterSpacing: '-0.36px', color: '#000', margin: 0 }}>
                    ...
                    <div style={{ display: 'flex', gap: 32, height: 360 }}>
                        <div style={{ flex: 1, borderRadius: 4, background: '#000', overflow: 'hidden', position: 'relative', padding: 32 }}>
                            ...
                            <div style={{ position: 'absolute', bottom: 32, left: 32, display: 'flex', alignItems: 'stretch', height: 40, borderRadius: 4, background: '#fff' }}>
                        ...
                        <div style={{ flex: 1, borderRadius: 4, background: '#fff', boxShadow: 'inset 0 0 0 1px rgba(0,0,0,0.08)', overflow: 'hidden', position: 'relative', padding: 33 }}>
                            ...
                            <div style={{ position: 'absolute', bottom: 33, left: 33, display: 'flex', alignItems: 'stretch', height: 40, borderRadius: 4, background: '#000' }}>
                    ...
                    <div style={{ borderRadius: 4, background: '#000', overflow: 'hidden', position: 'relative' }}>
                        ...
                        <div style={{ position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', padding: 64, minHeight: 399 }}>
                            <div style={{ width: 512, borderRadius: '4px 4px 0 0', background: '#fff', borderBottom: '1px solid rgba(0,0,0,0.08)', padding: 64, display: 'flex', flexDirection: 'column', gap: 32 }}>
                                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
